...
export const About: React.FC<AboutType> = () => {
    ...
    const contactTitle = s.contact_title
    const contactValue = s.contact_value
    ...
    return (
        <div className={!isMobile ? mainAbout : mainAboutMob}>
            <div className={isMobile ? aboutClassMob : aboutClassName}>
                <h2>Hi! My name is <span className={decor}>Maksim Aniska. </span>I am <span className={decor}>Front-end developer</span>
                </h2>
                <h3>I'm not so long in the frontend but I love it with all my heart.<br/>
                    I went through 2 stages of RSSchool courses, where I learned a lot about&nbsp;
                    <span className={decor}>JS</span>, <span className={decor}>HTML</span>, <span
                        className={decor}>CSS</span>,
                    ...
                    <span className={anotherDecor}>Redux Toolkit</span> at <a
                        href={"https://it-incubator.io/"}>IT-Incubator</a> courses,
                    ...
                    You can check it out by clicking on the menu above.</h3>
                <h3>I want to be your friend and colleague.<br/>
                    Contact me:<br/>
                </h3>
                ...
                <div className={contactValue}>
                    <a href="https://t.me/maksaniska">@maksaniska</a>
                </div>
            </div>
                <div className={contact}>
                    <div className={contactTitle}>
                    ...
                    <div className={contactValue}>
                        <a href="mailto:aniskamaksim@gmail.com">aniskamaksim@gmail.com</a>
                    </div>
                    </div>
                    <div className={contact}>
                        <div className={contactTitle}>gitHub:</div>
                        <div className={contactValue}>
                            <a href="https://github.com/aniskamaksim"
                                                         target={"_blank"} rel={"noreferrer"}>aniskamaksim</a>
                            </div>
                    </div>
                    <div className={contact}>
                        <div className={contactTitle}>phone:</div>
                        <div className={contactValue}>
                            <a href="tel:+375296313666">+375296313666</a>
                        </div>
                    </div>
                </div>
            </div>
            <div className={logoTags} style={{width: isMobile ? "40%" : ""}}>
                <img src={logorounded} className={isMobile ? imgLogoMob : imgLogo} alt={"Aniska Maksim Front-end developer"}></img>
                <div className={"cloud"}>
                    <TagCloud
                        style={{color: "#00cc22", display: isMobile ? "none" : "block"}}
